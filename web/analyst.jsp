...
<body>
        ...
        <li class="active"><a href="analyst.jsp">Analyst</a></li>
        ...
        <br/>
        <center><p><font color="black" size="5"> Analyst Login</font></p></center>

        <center>
        <form name="myform" action="analystact.jsp" method="post">
        <table border="0" >
