...
%>
    ...
    <table width="601" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
        ...
        <h1><font color="green" >Product Details </font></h1>
        <br/><br/>
   ...
   int j=0;
	...
	Statement st1 = connection.createStatement();
       ...
       if ( rs1.next() )
                    ...
                    %>
        <form action="addtocart.jsp?image=<%=s6%>" method="post">
        <tr>
        <td width="126" rowspan="7"><div class="style7" style="margin:10px 13px 10px 13px;" >
        <img height="200" width="120" src="Product Images\<%=s6%>"></img></div></td>
        </tr>
    ...
    <%
        String sql2="select * from reviews where pname = '"+productname+"' "; 
	Statement st2=connection.createStatement();
	ResultSet rs2=st2.executeQuery(sql2);
	%>
        
         <center>
             <h2><font color="black" size="5"> Reviews & Rating of </font><font color="red"> <%=productname%></font></h2>
        <br/>
        <style>
            td{
                text-align: center;
                    ...
                    <table border="2" width="70%">
                            ...
                            <th><font color="white">Review</th>
                            <th><font color="white">Rating</th>
    ...
    <tr>
         ...
         <td><font color="black"><textarea rows="2" cols="20"><%=rs2.getString(4)%></textarea></td>
         <td><font color="black"><%=rs2.getString(5)%></td>
        </tr>
            <%
                }
            %>
        ...
        PreparedStatement ps4=connection.prepareStatement ("insert into userintention (username,category,productname) values ('"+user+"','"+s1+"','"+s2+"')");
        ps4.executeUpdate();
