...
<%@page	import="java.util.*,java.text.SimpleDateFormat,java.util.Date,java.io.FileInputStream,java.io.FileOutputStream,java.io.PrintStream"%>
	...
	String sql2="select * from recommends"; 
	...
	while(rs2.next())
	{
		...
		if(m==0){
		%>
<table width="601" border="1.5" align="left"  cellpadding="0" cellspacing="0"  >
     <center><h1><font color='green'>View Recommended Products</font></h1></center> <br/> 
            <tr>
        ...
        <th width="101"> <a href="pdetails1.jsp?pname=<%=s2%>"><%=s2%></a></th>
