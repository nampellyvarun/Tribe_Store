...
<body>
        ...
        String query1="select distinct status from userintention where status = 'Cancelled'"; 
        Statement st1=connection.createStatement();
        ResultSet rs1=st1.executeQuery(query1);
        
        %>
        <center><h2>Canceled Analysis</h2></center>
        <p align="justify">
        <form action="canceledanalysis1.jsp" method="post" >
